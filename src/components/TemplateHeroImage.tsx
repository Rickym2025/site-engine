...
export default function TemplateHeroImage({ data, nomeCliente }: TemplateHeroImageProps) {
  ...
  // LOGICA DI ROTAZIONE CARD 3D TILT INTERATTIVA (Zero frame-drop, calcolata via CSS Variables)
  const handleMouseMove3D = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    // Inclina l'immagine proporzionalmente alla posizione del mouse
  ...
  return (
    ...
    >
      ...
      {/* ========================================================================= */}
      {/* CONTROLLO VISIVO TEMPLATE 1: EFFETTO GRANA SATINATA & PULSE DIETRO CARD */}
      {/* ========================================================================= */}
      
      {/* 1. Sovrapposizione di rumore analogico fine (Film Grain - Stile Refero Pro) */}
      <div className="fixed inset-0 z-40 opacity-[0.015] pointer-events-none bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPgo8cmVjdCB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjZmZmIiBmaWxsLW9wYWNpdHk9Ii4xNSIvPgo8L3N2Zz4=')] bg-repeat" /> [1]

      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {/* 2. Unica imponente sorgente di luce radiale fissa e pulsante posta dietro la foto Hero */}
        ...
        {/* Sfumatura verso il fondo scuro */}
      ...
      <header className="border-b border-zinc-900 bg-black/40 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 bg-zinc-950 border border-zinc-850 px-4 py-2 rounded-full">
            ...
            <span className="text-xs font-mono text-zinc-400 uppercase tracking-widest">Protocollo Attivo</span>
          </div>
        </div>
      </header>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-8 text-left">
          <motion.div
            ...
            className="inline-flex items-center bg-zinc-900/50 border border-zinc-850 px-4 py-1.5 rounded-full"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <a
              href="#servizi"
              className="bg-zinc-950 hover:bg-zinc-900 border border-zinc-900 text-white font-bold text-lg px-8 py-5 rounded-2xl flex items-center justify-center space-x-2 transition-all"
            >
              <span>{hero.cta2}</span>
        ...
        {/* L'IMMAGINE HERO CON TILT 3D ATTIVO AL MOVIMENTO MOUSE */}
        <div className="lg:col-span-5 relative">
          ...
          >
            {/* Lampo luminoso diagonale fisso sull'immagine al passaggio del mouse */}
